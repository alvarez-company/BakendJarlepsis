...
async function runMigration() {
  ...
  const migrationFile = path.resolve(__dirname, '../src/migrations/2025-12-05_update_instalacion_estado_enum.sql');
  ...
  try {
    ...
    try {
      ...
      // Si el ENUM ya tiene los valores, es un error esperado
