-- =====================================================
-- Migración completa para crear todas las tablas del sistema
...
CREATE TABLE IF NOT EXISTS `proyectos` (
  ...
  KEY `FK_a1900389f6aa7305d2018fc9e18` (`tipoProyectoId`),
  CONSTRAINT `FK_a1900389f6aa7305d2018fc9e18` FOREIGN KEY (`tipoProyectoId`) REFERENCES `tipos_proyecto` (`tipoProyectoId`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Tabla: items_proyecto
CREATE TABLE IF NOT EXISTS `items_proyecto` (
  `itemProyectoId` int NOT NULL AUTO_INCREMENT,
  `proyectoId` int NOT NULL,
  `materialId` int NOT NULL,
  `itemCantidad` decimal(10,2) NOT NULL,
  `itemNombre` varchar(255) DEFAULT NULL,
  ...
  KEY `FK_b4f373909da9224964e354e155c` (`materialId`),
  ...
  CONSTRAINT `FK_b4f373909da9224964e354e155c` FOREIGN KEY (`materialId`) REFERENCES `materiales` (`materialId`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `grupos` (
  ...
  `tipoGrupo` enum('general','oficina','bodega','instalacion') NOT NULL DEFAULT 'general',
